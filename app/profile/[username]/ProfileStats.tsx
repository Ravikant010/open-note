...
import { getPostStats, getPostStats_profile, getPostStats_profileByUserName } from '@/actions/reactionAction';
  ...
  useEffect(() => {
    const loadStats = async () => {
      try {
        ...
        const result = await getPostStats_profileByUserName(username);
